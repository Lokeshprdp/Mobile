...
%>
             ...
             <TD CLASS="TRData1" width="35%" align="left">Purchase No :</TD>
             <TD CLASS="TDData1">
             <%= data.get("purchase no") %>
             </TD>
             <TD CLASS="TRData1" width="35%" align="right">Purchase Date: </TD>
             <TD CLASS="TDData1">
             <%= data.get("purchase date") %>
             </TD>
             </TR>
             <TR ALIGN="left" class="TRData1">
             ...
             <TR ALIGN="left" class="TRData1">
             <TD CLASS="TRData1" width="25%" align="left">Supplier Name :</TD>
             <TD CLASS="TDData1">
             <%= data.get("supplier") %>
             </TD>
             </TR>
