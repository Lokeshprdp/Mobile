...
<script type="text/javascript">
 ...
 function validation()
 {
	var form = document.getElementById("frmcustomeradd");
	var suppliername = form["customername"].value;
...
<body>                                            
<FORM NAME="frmcustomeradd" method="POST" action="customeradd"  onsubmit="javascript:return validation();" style="margin:0px">
<table ALIGN='center' BORDER=0 CELLSPACING=0 CELLPADDING=0 WIDTH="100%">
		<TR CLASS='TRData1'>
				<TD ALIGN='center'>Add Customer Detail's</TD>
			</TR>

        <table align="center" border="0" cellspacing="0" cellpadding="0" width="60%">
          <TR HEIGHT='20px'><TD colspan='2'></TD></TR>
          <TR ALIGN="left">
          <TD class='TRData1'>Customer Name :</TD>
          <TD class='TDData1'>
          	<INPUT TYPE="text" name="customername" value='' class='textbox' size="50" >
          </TD>
          </TR>
          <TR HEIGHT='20px'><TD colspan='2'></TD></TR>
          <TR ALIGN="left">
