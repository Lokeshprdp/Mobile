...
<TABLE ALIGN='center' BORDER=0 CELLSPACING=0 CELLPADDING=0 WIDTH="100%">					
			<TR CLASS='TRData1'>
				<TD ALIGN='center'>Supplier List</TD>
				
			</TR> 
			
			<TR>
	     <TD ALIGN="right"> | 
       	  <A accesskey="a" href="supplierAdd.jsp"><u>A</u>dd Supplier</A> | 
	      </TD>
	    </TR>
	</TABLE>
...
<td nowrap=true CLASS="TDData1"><a href='/Mobile/supplierEdit?supplierid=<%= itr.next() %>'><%= itr.next()%></a></td>
</tr>
<%
}
%>
